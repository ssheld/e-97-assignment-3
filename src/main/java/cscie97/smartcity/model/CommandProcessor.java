...
public class CommandProcessor {
    ...
    public static void processCommand(String[] command, int lineNumber) throws CommandProcessorException {
        ...
        try {
            if (command[0].toLowerCase().equals("define")) {
            ...
            } else if (command[0].toLowerCase().equals("update")) {
            ...
            } else if (command[0].toLowerCase().equals("show")) {
                switch(command[1].toLowerCase()) {
                    case "city":
            ...
            } else if (command[0].toLowerCase().equals("create")) {
